---
title: New Senior Skill in Agentic Coding: Ability to say “NO”
description: New Senior Skill in Agentic Coding: Ability to say "NO" — an essay by Kevin Wen.
summary: AI can accelerate implementation. Senior engineering judgment decides what should be built and what should not.
date: 2026-05-08
tags: [agentic-engineering, engineering-leadership, career-development]
hero: say-no-1.png
medium: https://medium.com/@kevinwen/new-senior-skill-in-agentic-coding-ability-to-say-no-b13592b2ed5b
order: 12
---

### New Senior SKill in Agentic Coding

![Illustration of AI output flowing through human judgment before shipping.](../assets/articles/say-no-1.png)
...
![Illustration contrasting visible AI wins with hidden production risks.](../assets/articles/say-no-2.png)
...
![Decision framework for applying AI based on problem clarity and business risk.](../assets/articles/say-no-3.png)
