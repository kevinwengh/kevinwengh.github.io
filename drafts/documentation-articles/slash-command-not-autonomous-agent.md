...
source_note: docs/designs/goal-command-implementation-comparison.md
---

# A Slash Command Is Not an Autonomous Agent
...
1. Where is the objective persisted?
2. Who evaluates completion after a turn?
3. How is the next turn scheduled, paused, or preempted?
4. What stops an incorrect loop from continuing indefinitely?
